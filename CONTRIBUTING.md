...
6. Document compatibility, migration, dependency, and research-status impact.
7. Run the same canonical command used by CI: `npm run verify`.
8. Confirm the contribution is yours to license under Apache-2.0.
